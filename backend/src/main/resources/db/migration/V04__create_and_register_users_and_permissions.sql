...
INSERT INTO permission (id, description) values (2, 'ROLE_RESEARCH_CATEGORY');
...
INSERT INTO permission (id, description) values (5, 'ROLE_RESEARCH_PERSON');

INSERT INTO permission (id, description) values (6, 'ROLE_REGISTER_LAUNCHING');
INSERT INTO permission (id, description) values (7, 'ROLE_DELETE_LAUNCHING');
INSERT INTO permission (id, description) values (8, 'ROLE_RESEARCH_LAUNCHING');
